...
# Fichier identique à ce qui est donné dans le sujet, à quelques différences dans la partie exécutable
# en fin de fichier
...
if __name__ == "__main__":
    ...
    saisie = input("Entrez l'operation 1) cacher 2) retrouver [%s]"%choix_defaut)
